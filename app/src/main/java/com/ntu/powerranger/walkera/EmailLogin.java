...
public class EmailLogin extends AppCompatActivity  {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            String postURL = getResources().getString(R.string.apiURL) + "user/registerOrLogin";
            ApplicationController.getInstance().getRequestQueue().getCache().remove(postURL);
            ...
            StringRequest req = new StringRequest(Request.Method.POST, postURL,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            String msg = (String)arr.get("message");

                            Intent myIntent = new Intent(EmailLogin.this, EmailLoginDetail.class);
                            EmailLogin.this.startActivity(myIntent);
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    mEmailView.setError((String)arr.get("message"));
